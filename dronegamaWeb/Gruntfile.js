...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      js: {
        files: ['<%= yeoman.app %>/app/static/scripts/{,*/}*.js'],
    ...
    jshint: {
      ...
      all: {
        src: [
          'Gruntfile.js',
          '<%= yeoman.app %>/app/static/scripts/{,*/}*.js'
        ]
      },
      test: {
        options: {
    ...
    compass: {
      options: {
        ...
        javascriptsDir: '<%= yeoman.app %>/app/static/scripts',
    ...
    filerev: {
      dist: {
        src: [
          '<%= yeoman.dist %>/app/static/scripts/{,*/}*.js',
    ...
    usemin: {
      ...
      js: ['<%= yeoman.dist %>/app/static/scripts/{,*/}*.js'],
      options: {
        assetsDirs: [
          '<%= yeoman.dist %>',
          '<%= yeoman.dist %>/images',
